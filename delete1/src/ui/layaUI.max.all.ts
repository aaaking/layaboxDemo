...
module ui.res {
    export class PieUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{"width":600,"height":400},"child":[{"type":"Pie","props":{"y":0,"x":45,"startAngle":27.516875253828857,"radius":50,"lineWidth":1,"fillColor":"#ff0000","endAngle":135}}]};
        constructor(){ super()}
        createChildren():void {
