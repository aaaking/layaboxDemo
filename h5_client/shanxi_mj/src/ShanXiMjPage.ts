class ShanXiMjPage extends BaseMJPage{
    constructor(){
        super()
        this.name = "ShanXiMjPage";
        ...
        AppPage.register(ShanXiMjPage, this._loadDatas);
    ...
    protected init(...params): void {
        ...
        BaseHandCardManager.instance.registerClass(shanxi_mj.HandCardView)
        BaseFoldCardManager.instance.registerClass(BaseFoldCardView)
        BaseWinCardManager.instance.registerClass(shanxi_mj.WinCardView)
        BaseHoldCardManager.instance.registerClass(BaseHoldCardView)
        BaseTingCardManager.instance.registerClass(BaseTingCardView)
        PlayerManager.instance.registerClass(shanxi_mj.GamePlayerView)
        ...
        let callback = function(){
            ...
            if(!BaseGameData.isRecord){
                if (BaseGameData.selfSeatid){
                    BaseGameData.leftCard = BaseGameData.leftCard - 39
                }else{
